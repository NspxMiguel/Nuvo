...
window.IDIOMAS = {
  en: {
    ...
    'Prova passada é amostra do que ele cobra; material de aula é o universo do que ele ensina. A distância entre os dois é a previsão. O app lê as provas e descobre o jeito do professor: o peso de cada tema, o nível que ele exige, os verbos que ele usa, e o que ele ensina e nunca cobrou.': 'A past exam is a sample of what they ask for; class material is the universe of what they teach. The distance between the two is the forecast. The app reads the exams and works out how the teacher asks: the weight of each topic, the level they demand, the verbs they use, and what they teach and never ask about.',
